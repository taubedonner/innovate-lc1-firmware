...
Длительности полуволн T1 и T2 запоминаются раздельно. Это измеритель
лямбды, а не температуры: ни период, ни сумма полуволн нигде в прошивке
не превращаются в сопротивление.
...
токе. Для ячейки накачки - то же самое через `VPUMP_SENSE` и
...
Iheat` и хранится в миллиомах. Регулируемая величина меняется по ходу
работы:
...
Уставка 7500 для LSU 4.9 - это паспортная рабочая точка Bosch: при
номинальных 7.5 В и мощности около 7.5 Вт в равновесии сопротивление
горячего нагревателя равно 7.5 Ом. Порог обрыва 1800 совпадает с
паспортным минимальным холодным сопротивлением 1.8 Ом.
